/*
  ...
  - You are about to alter the column `passwordResetExpiration` on the `Security` table. The data in that column could be lost. The data in that column will be cast from `String` to `BigInt`.
...
CREATE TABLE "new_Security" (
    ...
    "passwordResetExpiration" BIGINT NOT NULL,
    "passwordResetToken" TEXT,
    "confirmEmailAccount" BOOLEAN NOT NULL,
    "confirmEmailToken" TEXT NOT NULL,
    "confirmEmailExpiration" BIGINT NOT NULL,
